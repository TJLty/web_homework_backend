...
import lty.web2021.backend.config.OSSConfiguration;
...
public class OSSService {
     ...
     * @return
     */
    public String uploadImage(MultipartFile file, String storagePath) {
        String fileName = "";
        try {
            // 创建一个唯一的文件名，类似于id，就是保存在OSS服务器上文件的文件名
            String[] names =file.getOriginalFilename().split("\\.");
    ...
    public String getBaseUrl(){
        return ossConfiguration.getBaseUrl();
    }
}
